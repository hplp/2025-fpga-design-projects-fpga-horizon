...
HD_PWD='C:/Omega/Image_processing/Image_processing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log box_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source box_wrapper.tcl -notrace
