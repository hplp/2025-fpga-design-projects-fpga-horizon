...
HD_PWD='C:/Omega/Image_processing/Image_processing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log box_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source box_wrapper.tcl
