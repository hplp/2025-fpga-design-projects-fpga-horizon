...
HD_PWD='C:/Omega/Image_processing/Image_processing.runs/box_boxBlur_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log box_boxBlur_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source box_boxBlur_0_0.tcl
